...
const translations: Record<Language, TranslationDict> = {
  zh: {
    ...
    /* ---- Agent Optimization ---- */
    "agent.title": "AI 优化 Agent",
    "agent.configTitle": "配置优化参数",
    "agent.noBaseline": "无法获取此提示词的基准信息。请先确保提示词存在且已运行过实验。",
    "agent.targetScore": "目标分数",
    "agent.maxIterations": "最大迭代",
    "agent.startOptimize": "开始优化",
    "agent.optimizing": "优化中...",
    "agent.currentBaseline": "当前 Baseline：",
    "agent.baselineScore": "得分",
    "agent.progress": "优化过程",
    "agent.preparing": "Agent 正在准备，即将开始优化...",
    "agent.strategy": "策略",
    "agent.thought": "思考",
    "agent.roundLabel": "Round {round}",
    "agent.scoreLabel": "得分：{score}",
    "agent.improvementLabel": "↑{diff}",
    "agent.targetReached": "达标！",
    "agent.results": "结果",
    "agent.results.success": "🎉 {rounds} 轮完成！胜出版本 v{version}，得分 {score}/100",
    "agent.results.notReached": "⚠️ {rounds} 轮完成但未达标。最佳版本 v{version}，得分 {score}/100",
    "agent.results.rounds": "总轮次",
    "agent.results.bestScore": "最佳得分",
    "agent.results.improvement": "总提升",
    "agent.results.winnerVersion": "胜出版本",
    "agent.backToPrompt": "返回提示词详情",
    "agent.error.title": "优化失败",
    "agent.error.noVersions": "此提示词没有可用版本",
  },
  ...
  en: {
    ...
    /* ---- Agent Optimization ---- */
    "agent.title": "AI Optimization Agent",
    "agent.configTitle": "Optimization Settings",
    "agent.noBaseline": "Cannot read baseline info for this prompt. Make sure the prompt exists and has completed experiments.",
    "agent.targetScore": "Target Score",
    "agent.maxIterations": "Max Iterations",
    "agent.startOptimize": "Start Optimizing",
    "agent.optimizing": "Optimizing...",
    "agent.currentBaseline": "Current Baseline:",
    "agent.baselineScore": "Score",
    "agent.progress": "Optimization Progress",
    "agent.preparing": "Agent is preparing, optimization will start soon...",
    "agent.strategy": "Strategy",
    "agent.thought": "Thought",
    "agent.roundLabel": "Round {round}",
    "agent.scoreLabel": "Score: {score}",
    "agent.improvementLabel": "+{diff}",
    "agent.targetReached": "Target Reached!",
    "agent.results": "Results",
    "agent.results.success": "{rounds} rounds completed! Winner: v{version}, Score: {score}/100",
    "agent.results.notReached": "{rounds} rounds completed but target not reached. Best: v{version}, Score: {score}/100",
    "agent.results.rounds": "Total Rounds",
    "agent.results.bestScore": "Best Score",
    "agent.results.improvement": "Improvement",
    "agent.results.winnerVersion": "Winner Version",
    "agent.backToPrompt": "Back to Prompt Details",
    "agent.error.title": "Optimization Failed",
    "agent.error.noVersions": "This prompt has no available versions",
  },
};
