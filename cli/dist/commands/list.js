...
export async function list() {
    ...
    try {
        ...
        if (!prompts || prompts.length === 0) {
            ...
            console.log(chalk.dim("  Create one by pushing a .prompt.md file: ") +
        ...
        console.log();
        console.log(chalk.dim("  Pull a prompt: ") +
        ...
        if (err instanceof ApiError) {
            ...
            if (err.status === 401) {
                console.error(chalk.yellow("  Hint: Authentication required. Set PROMPTLAB_TOKEN to authenticate."));
            }
        }
        else {
